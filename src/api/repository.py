...
@router.delete("/all")
async def delete_all_repos(service: GithubService = Depends(get_github_service)):
    try:
...
@router.get("/all")
async def get_all_repos(service: GithubService = Depends(get_github_service)):
    try:
...
async def get_repo_details(
    name: str, service: GithubService = Depends(get_github_service)
):
    try:
